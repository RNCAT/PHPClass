...
if (isset($_POST["submit"])) {
    ...
    if (isset($_POST["edit"])) {
        if ($objEmpType->update($emp_type_id, $emp_type)) {
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <h3 style="text-align: center;">แก้ไขประเภทพนักงาน</h3>
                            <div class="d-grid gap-1">
                                <label for="emp_type_id">รหัสประเภทพนักงาน:</label>
                                <input type="text" name="emp_type_id" id="emp_type_id" value="<?php echo $emp_type_id; ?>">
                            </div><br>
                            <div class="d-grid gap-1">
                                <label for="emp_type">ชื่อประเภทพนักงาน:</label>
                                <input type="text" name="emp_type" id="emp_type" value="<?php echo $emp_type; ?>">
                            </div><br>
                            <div class="d-grid gap-1">
