...
if (isset($_POST["submit"])) {
    ...
    if ($objWorkType->insert($work_type_id, $work_type_name)) {
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post">
                            <h3 style="text-align: center;">เพิ่มประเภทงาน</h3>
                            <div class="d-grid gap-1">
                                <label for="work_type_id">รหัสประเภทงาน:</label>
                                <input type="text" name="work_type_id" id="work_type_id">
                            </div><br>
                            <div class="d-grid gap-1">
                                <label for="work_type_name">ชื่อประเภทงาน:</label>
                                <input type="text" name="work_type_name" id="work_type_name">
                            </div><br>
                            <div class="d-grid gap-1">
